...
FoodEntry::FoodEntry(const Food& food, double quantityInGrams, const Date& date)
    : food(food), date(date), quantityGrams(quantityInGrams), id(nextId++) {
